...
PxmlInitThreads = procedure(); cdecl;
PxmlInitParser = procedure(); cdecl;
P__xmlLoadExtDtdDefaultValue = function(): PInteger; cdecl;
PxmlSubstituteEntitiesDefault = function(val: Longint): Longint; cdecl;
P__xmlIndentTreeOutput = function(): PInteger; cdecl;
PxmlCleanupParser = procedure(); cdecl;
PxmlParseDoc = function(const cur: xmlCharPtr): xmlDocPtr; cdecl;
PxmlDocGetRootElement = function(doc: xmlDocPtr): xmlNodePtr; cdecl;
PxmlReadFile = function(const filename: PAnsiChar; const encoding: PAnsiChar; options: Longint): xmlDocPtr; cdecl;
PxmlSchemaNewDocParserCtxt = function(doc: xmlDocPtr): xmlSchemaParserCtxtPtr; cdecl;
PxmlSchemaParse = function(ctxt: xmlSchemaParserCtxtPtr): xmlSchemaPtr; cdecl;
PxmlSchemaNewValidCtxt = function(schema: xmlSchemaPtr): xmlSchemaValidCtxtPtr; cdecl;
PxmlSchemaValidateDoc = function(ctxt: xmlSchemaValidCtxtPtr; doc: xmlDocPtr): Longint; cdecl;
PxmlGetLastError = function(): xmlErrorPtr; cdecl;
PxmlFreeDoc = procedure(cur: xmlDocPtr); cdecl;
PxmlSchemaFreeParserCtxt = procedure(ctxt: xmlSchemaParserCtxtPtr); cdecl;
PxmlSchemaFreeValidCtxt = procedure(ctxt: xmlSchemaValidCtxtPtr); cdecl;
PxmlSchemaFree = procedure(schema: xmlSchemaPtr); cdecl;
PxmlDocDumpMemory = procedure(cur: xmlDocPtr; mem: xmlCharPtrPtr; size: PInteger); cdecl;

{=== Methods Declarations - modified in 3/Nov/2015  by m.h. ===}
procedure xmlInitThreads();
procedure xmlInitParser();
function __xmlLoadExtDtdDefaultValue(): PInteger;
function xmlSubstituteEntitiesDefault(val: Longint): Longint;
function __xmlIndentTreeOutput(): PInteger;
...
function xmlReadFile(const filename: PAnsiChar; const encoding: PAnsiChar; options: Longint): xmlDocPtr;
function xmlSchemaNewDocParserCtxt(doc: xmlDocPtr): xmlSchemaParserCtxtPtr;
...
begin
  ...
  if lHandle = NilHandle then
    Exit;
  try
    DoGet__xmlLoadExtDtdDefaultValue := P__xmlLoadExtDtdDefaultValue(GetProcAddress(lHandle, '__xmlLoadExtDtdDefaultValue'));
    if @DoGet__xmlLoadExtDtdDefaultValue <> Nil then
      Result := DoGet__xmlLoadExtDtdDefaultValue();
  finally
    FreeLibrary(lHandle);
  end;
end;
...
begin
  ...
  if lHandle = NilHandle then
    Exit;
  try
    DoGet__xmlIndentTreeOutput := P__xmlIndentTreeOutput(GetProcAddress(lHandle, '__xmlIndentTreeOutput'));
    if @DoGet__xmlIndentTreeOutput <> Nil then
      Result := DoGet__xmlIndentTreeOutput();
  finally
    FreeLibrary(lHandle);
  end;
end;
